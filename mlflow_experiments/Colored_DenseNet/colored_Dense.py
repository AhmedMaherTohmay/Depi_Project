...
model = load_model('mlflow_experiments\Colored_DenseNet\colored_Dense.keras')
...
with mlflow.start_run():
    mlflow.log_param("model", "colored_Dense.keras")
    ...
    model_artifact_path = "model/colored_Dense"
