...
model = load_model('mlflow_experiments\Gray_CNN\gray_CNN.h5')
...
def preprocess_image(image_path):
    ...
    img_array = cv2.resize(img_array, (70, 70))  # Resize to match the input size of the model
...
with mlflow.start_run():
    mlflow.log_param("model", "gray_CNN.h5")
